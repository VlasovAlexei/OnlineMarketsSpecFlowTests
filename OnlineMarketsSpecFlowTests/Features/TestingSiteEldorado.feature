...
Scenario: BuyOfOneProduct
	...
	When I'm waiting "3000" milliseconds for the page to become static
	And I click on search field and enter the product to search "iPhone 11" on the start page
